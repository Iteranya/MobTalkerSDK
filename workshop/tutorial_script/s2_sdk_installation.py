...
def story():
    ...
    vn.say(a,"So... apologies in advance, Ars, but you'll have to start taking a lot of screenshots...")
    vn.remove("installation_flow")
    vn.background("installation_1")
    vn.say(a,"Download python, install it, the basic")
    vn.clear_background()
    vn.background("installation_2")
    vn.say(a,"The dev recommend VS Code")
    vn.say(a,"Next up is... you open the stuff you cloned into VS-Code")
    vn.clear_background()
    vn.background("installation_3")
    ...
    vn.say(a,"You can insert this single json file into your 'config/mobtalkerredux/' folder and run it in Minecraft")
