...
from tutorial_script import s1_introduction_installation,s2_sdk_installation,s3_character_sprites,s4_choices_labels,s5_minecraft_deployment,s6_advanced_sprite,s7_variables_system,s8_random_interaction,s9_interaction_structure,s10_under_the_hood
scripts = [
    s1_introduction_installation.story(),
    s2_sdk_installation.story(),
    s3_character_sprites.story()
